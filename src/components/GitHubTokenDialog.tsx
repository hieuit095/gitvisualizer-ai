...
import { ExternalLink, Eye, EyeOff, KeyRound, Lock } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { getStoredToken, storeToken } from "@/lib/githubToken";
      ...
      <DialogContent className="border-border/50 bg-card sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">
            Add a Personal Access Token to analyze private repositories. Your
            token stays in your browser and is only sent to GitHub's API when
            you analyze a repo.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="rounded-lg border border-border/50 bg-muted/30 p-3 text-xs text-muted-foreground">
            ...
            <ol className="list-inside list-decimal space-y-1">
              ...
              <li>Select "Personal access tokens" then "Fine-grained tokens".</li>
              <li>
                Create a token with{" "}
